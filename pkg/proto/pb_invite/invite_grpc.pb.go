...
type InviteClient interface {
	NewChatInvite(ctx context.Context, in *NewChatInviteReq, opts ...grpc.CallOption) (*NewChatInviteResp, error)
...
func (c *inviteClient) NewChatInvite(ctx context.Context, in *NewChatInviteReq, opts ...grpc.CallOption) (*NewChatInviteResp, error) {
	out := new(NewChatInviteResp)
	err := c.cc.Invoke(ctx, "/pb_invite.Invite/NewChatInvite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InviteServer interface {
	NewChatInvite(context.Context, *NewChatInviteReq) (*NewChatInviteResp, error)
...
func (UnimplementedInviteServer) NewChatInvite(context.Context, *NewChatInviteReq) (*NewChatInviteResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewChatInvite not implemented")
}
...
func _Invite_NewChatInvite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewChatInviteReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InviteServer).NewChatInvite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb_invite.Invite/NewChatInvite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InviteServer).NewChatInvite(ctx, req.(*NewChatInviteReq))
	}
...
var Invite_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NewChatInvite",
			Handler:    _Invite_NewChatInvite_Handler,
		},
		{
