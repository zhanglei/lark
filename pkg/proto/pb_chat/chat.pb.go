...
type NewChatReq struct {
	...
	OwnerType pb_enum.AVATAR_OWNER `protobuf:"varint,1,opt,name=owner_type,json=ownerType,proto3,enum=pb_enum.AVATAR_OWNER" json:"owner_type,omitempty"`
}
...
func (x *NewChatReq) GetOwnerType() pb_enum.AVATAR_OWNER {
	if x != nil {
		return x.OwnerType
	}
...
var file_pb_chat_chat_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x42, 0x0a, 0x0a, 0x4e, 0x65, 0x77, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x12,
	0x34, 0x0a, 0x0a, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20,
	...
	0x72, 0x54, 0x79, 0x70, 0x65, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x70, 0x62, 0x5f, 0x63, 0x68,
	0x61, 0x74, 0x3b, 0x70, 0x62, 0x5f, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_pb_chat_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pb_chat_chat_proto_goTypes = []interface{}{
	(*NewChatReq)(nil),        // 0: pb_chat.NewChatReq
	(pb_enum.AVATAR_OWNER)(0), // 1: pb_enum.AVATAR_OWNER
}
var file_pb_chat_chat_proto_depIdxs = []int32{
	1, // 0: pb_chat.NewChatReq.owner_type:type_name -> pb_enum.AVATAR_OWNER
