...
type Message struct {
	...
	SenderNickname  string `gorm:"column:sender_nickname;NOT NULL" json:"sender_nickname" bson:"sender_nickname"`           // 发送者昵称
	SenderAvatarUrl string `gorm:"column:sender_avatar_url;NOT NULL" json:"sender_avatar_url" bson:"sender_avatar_url"`     // 发送者头像
