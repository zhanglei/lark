...
type Avatar struct {
	...
	AvatarSmall  string `gorm:"column:avatar_small;NOT NULL" json:"avatar_small"`   // 小图 72*62
	AvatarMedium string `gorm:"column:avatar_medium;NOT NULL" json:"avatar_medium"` // 中图 240*240
	AvatarLarge  string `gorm:"column:avatar_large;NOT NULL" json:"avatar_large"`   // 大图 640*640
}
