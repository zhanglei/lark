...
const (
	...
	WS_HEADER_LENGTH            = 4
	WS_CHAN_CLIENT_SEND_MESSAGE = 1000
	WS_CHAN_HEARTBEAT_MESSAGE   = 10
	WS_CHAN_SERVER_READ_MESSAGE = 10000
	WS_CHAN_CLIENT_REGISTER     = 10000
	WS_CHAN_CLIENT_UNREGISTER   = 1000
...
var (
	...
	WS_MSG_BUF_PING    = make([]byte, 0)
	WS_MSG_BUF_PONG    = make([]byte, 0)
	WS_MSG_BUF_CLOSE   = make([]byte, 0)
)
